...
import EngineTab from '../../../common/device_comp/EngineTab';
import GeneratorTab from '../../../common/device_comp/GeneratorTab';
import AlarmsTab from '../../../common/device_comp/AlarmsTab';
import { TabButtons, TabOption } from '@/components/common/device_comp/TabButtons';
...
export default function DeviceDetails() {
  ...
  return (
    <div className="flex flex-col relative h-[calc(100vh-3rem)] bg-transparent text-text-primary">
