...
import { fetchMeters } from "@/store/slices/manager/managerThunks";
import { RootState, AppDispatch } from "@/store";
import { SearchIcon } from "lucide-react";
import { GetMeters } from "@/store/slices/manager/managerTypes";
import { fetchDeviceData } from "@/store/slices/admin/adminThunks";

export default function Devices() {
  const dispatch = useDispatch<AppDispatch>();
  const { get_meters } = useSelector((state: RootState) => state.manager);
